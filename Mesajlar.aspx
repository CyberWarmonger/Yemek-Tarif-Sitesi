                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style3">
                           <a href="MesajDetay.aspx?Mesajid=<%#Eval("Mesajid") %>"><asp:Image ID="Image4" runat="server" Height="30px" ImageUrl="~/resimler/indir.png" style="text-align: left" Width="30px" /></a> 
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
